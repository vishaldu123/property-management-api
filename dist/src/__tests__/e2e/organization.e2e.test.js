...
describe('Organization Module E2E', () => {
    ...
    it('creates an organization (public endpoint)', async () => {
        const createResponse = await (0, supertest_1.default)(app_1.default).post('/api/organizations').send({
    ...
    it('registers users and gets auth context', async () => {
        await (0, supertest_1.default)(app_1.default).post('/api/auth/register').send(primaryUser).expect(201);
        await (0, supertest_1.default)(app_1.default).post('/api/auth/register').send(secondaryUser).expect(201);
