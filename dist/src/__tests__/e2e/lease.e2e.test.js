...
describe('Lease Domain E2E Tests', () => {
    ...
    afterAll(async () => {
        // Cleanup
        await prisma_1.default.lease.deleteMany({
    ...
    describe('Authorization', () => {
        it('should return 401 without authentication token', async () => {
            const res = await (0, supertest_1.default)(app_1.default).get('/api/v1/leases');
